...
struct SwigDirector_Router2DebugInterface : public RakNet::Router2DebugInterface, public Swig::Director {

public:
    SwigDirector_Router2DebugInterface();
    virtual ~SwigDirector_Router2DebugInterface();
    virtual void ShowFailure(char const *message);
    virtual void ShowDiagnostic(char const *message);

    typedef void (SWIGSTDCALL* SWIG_Callback0_t)(char *);
    typedef void (SWIGSTDCALL* SWIG_Callback1_t)(char *);
    void swig_connect_director(SWIG_Callback0_t callbackShowFailure, SWIG_Callback1_t callbackShowDiagnostic);

private:
    SWIG_Callback0_t swig_callbackShowFailure;
    SWIG_Callback1_t swig_callbackShowDiagnostic;
    void swig_init_callbacks();
};
